...
class Select extends Component {
    ...
    */
    ...
    render() {
        const { label, mapping, disabled, style, required, id } = this.props;
        ...
        return (
            <Fragment>
                ...
                <div style={style}>
                    {mapping.color ? (<div style={{ backgroundColor: `${(backGroundColor !== null && backGroundColor) ? backGroundColor : (selectedItem !== null && selectedItem.code) ? selectedItem.code : ""}`, marginTop: "-29px", height: "10px", width: "100%", borderRadius: "5px" }}></div>) : null}
                </div>
            </Fragment>
        )
    }
